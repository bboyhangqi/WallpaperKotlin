 ...
 */
class BottomNavigationView : View {
    ...
    private fun init(attrs: AttributeSet?, defStyle: Int) {
        ...
        val a = context.obtainStyledAttributes(
                attrs, R.styleable.BottomNavigationView, defStyle, 0)

        mExampleString = a.getString(
                R.styleable.BottomNavigationView_exampleString)
        mExampleColor = a.getColor(
                R.styleable.BottomNavigationView_exampleColor,
                mExampleColor)
        // Use getDimensionPixelSize or getDimensionPixelOffset when dealing with
        // values that should fall on pixel boundaries.
        mExampleDimension = a.getDimension(
                R.styleable.BottomNavigationView_exampleDimension,
                mExampleDimension)

        if (a.hasValue(R.styleable.BottomNavigationView_exampleDrawable)) {
            exampleDrawable = a.getDrawable(
                    R.styleable.BottomNavigationView_exampleDrawable)
